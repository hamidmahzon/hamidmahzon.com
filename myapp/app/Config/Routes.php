...
$routes->get('lang', 'HomeController::lang');
$routes->get('color/(:any)', 'HomeController::color/$1');
$routes->get('resume', 'ResumeController::index');

$routes->get('project', 'ProjectController::index');
$routes->get('video', 'VideoController::index');

$routes->get('note', 'NoteController::index');
$routes->get('note/(:any)', 'NoteController::index/$1');
