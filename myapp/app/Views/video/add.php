...
<div class="w3-modal-content w3-card-4 w3-animate-opacity">
    ...
    <br>
    <form class="w3-container" action="<?=base_url('add/video')?>" method="post" id="frm" name="frm">
        <div class="w3-row-padding w3-text-black">
            ...
            <div class="w3-half">
                <input class="w3-input w3-border w3-margin-bottom" type="text" name="link" id="link">
            </div>
