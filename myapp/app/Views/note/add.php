...
<div class="w3-modal-content w3-card-4 w3-animate-opacity">
    ...
    <br>
    <form class="w3-container" action="<?=base_url('add/note')?>" method="post" id="frm" name="frm">
        <div class="w3-row-padding w3-text-black">
            <div class="w3-quarter w3-<?=$align?>">
                <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="<?=lang('app.namep')?>" name="namep" id="namep" autofocus>
            </div>
            <div class="w3-quarter w3-<?=$align?>">
                <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="<?=lang('app.namee')?>" name="namee" id="namee">
            </div>
            <div class="w3-quarter w3-<?=$align?>">
			...
			<div class="w3-quarter w3-<?=$align?>">
                <input class="w3-input w3-border w3-margin-bottom" type="date" value="<?=date('Y-m-d')?>" name="created_at" id="created_at">
            </div>
            <div class="w3-half w3-<?=$align?>">
                <label class="w3-label w3-<?=$align?>"><?=lang('app.notep')?></label>
                <textarea name="notep" id="notep" rows="8" class="content w3-input w3-border w3-margin-bottom ns-resize-0"></textarea>
            </div>
            <div class="w3-half w3-<?=$align?>">
                <label class="w3-label w3-<?=$align?>"><?=lang('app.notee')?></label>
                <textarea name="notee" id="notee" rows="8" class="content1 w3-input w3-border w3-margin-bottom ns-resize-0"></textarea>
            </div>
            <?= csrf_field() ?>
